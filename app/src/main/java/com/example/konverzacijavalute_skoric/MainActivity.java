package com.example.konverzacijavalute_skoric;
        ...
        gumb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(izbornik.getSelectedItem().toString() == "Srednji"){
                    pareEUR = (double) Math.round((amount/7.53)*100)/100;
                    pareUSD = (double) Math.round((amount/7.064)*100)/100;
                    pareCHF = (double) Math.round((amount/7.65)*100)/100;
                    ...
                    pareEUR = (double) Math.round((amount/7.51)*100)/100;
                    pareUSD = (double) Math.round((amount/7.04)*100)/100;
                    pareCHF = (double) Math.round((amount/7.63)*100)/100;
                    EUR.setText(pareEUR.toString());
                    USD.setText(pareUSD.toString());
                    CHF.setText(pareCHF.toString());
                }
                else if (izbornik.getSelectedItem().toString() == "Prodajni"){
                    pareEUR = (double) Math.round((amount/7.56)*100)/100;
                    pareUSD = (double) Math.round((amount/7.08)*100)/100;
                    pareCHF = (double) Math.round((amount/7.67)*100)/100;
                    EUR.setText(pareEUR.toString());
                    USD.setText(pareUSD.toString());
                    CHF.setText(pareCHF.toString());
                }
